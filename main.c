...
/*   Updated: 2019/09/03 17:00:03 by jormond-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int     main()
{
	...
	// ft_printf("31)|%015u| - My 'lu'\n", 4294967295);
    // printf("31)|%015u| - Orig 'lu'\n\n", 4294967295);
	
	// ft_printf("%lu", 18446744073709551574);
	...
	ft_printf("31)|%-#6o| - My 'o'\n", 2500);
    printf("31)|%-#6o| - Orig 'o'\n\n", 2500);

	ft_printf("32)|%-#6o| - My 'o'\n", 41);
    printf("32)|%-#6o| - Orig 'o'\n\n", 41);

	ft_printf("33)|%-10.5o| - My 'o'\n", 2500);
	printf("33)|%-10.5o| - Orig 'o'\n\n", 2500);
